...
Las fuentes de información para las estadísticas oficiales se está diversificando

--

La información web se está volviendo cada vez más relevante
...
rD1 <- rsDriver(browser = "chrome", port = 4567L, geckover = NULL,
                chromever = version[[1]][3], iedrver = NULL, phantomver = NULL)
remDr <- rD1[["client"]]
